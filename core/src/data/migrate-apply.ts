...
export async function applySchema(db: Db, app: App): Promise<void> {
  ...
  // per-agent scheduling-cap counter (05-runtime.md §multi-replica-scheduling) — a born-on floor, created whenever the app
  ...
  // effectively-once fence (05-runtime.md §relay): the composite PK (consumer, msg_id) dedups per consumer,
