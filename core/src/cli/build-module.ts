...
// a dispatcher runs, so an unrecognised verb never reaches a handler. Pinned by equality in cli-module.test.ts.
 ...
 *  capability.
 *
 *  `cli-module.test.ts` holds this EQUAL to the `cmd === "…"` dispatch points scanned out of `src/cli/`,
