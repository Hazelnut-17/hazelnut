...
// a dispatcher runs, so an unrecognised verb never reaches a handler. Pinned by equality.
 ...
 *  capability.
 *
 *  An equality against the `cmd === "…"` dispatch points scanned out of `src/cli/`,
