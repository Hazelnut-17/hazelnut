 ...
 *  verify module directly, and `import type` is erased at runtime so it looked carve-safe — but it is a
 *  STATIC edge into a withheld directory, and the carve gate could not see it: `deno info` merges a
