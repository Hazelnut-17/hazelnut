...
export interface OutboxMsg {
  ...
  /**
   * The 05-runtime.md §relay envelope columns — all optional (additive); `ctx.emit` stamps these from the live
...
// ─── per-agent scheduling abuse cap (05-runtime.md §multi-replica-scheduling) ─────────────────────────────────────────────
