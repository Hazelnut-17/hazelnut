...
| `tasks/unstable-cron`   | the serve tasks carry the flag                                              | a serve task lacks it — in-process scheduler refuses at boot; `scheduler: "external"` does not use Deno.cron | —                                                              |
