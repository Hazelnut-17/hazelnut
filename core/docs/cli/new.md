...
```
{{name}}/
├─ deno.json            # tasks + imports (+ a lint plugin — floor on core, floor+discipline on the full build)
...
| File                                                                                         | What it is                                                                                                                                                |
| -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `deno.json`                                                                                  | tasks, imports, `nodeModulesDir: "auto"` — and a lint plugin: the 9-rule floor on core, floor plus the verify module's discipline rules on the full build |
