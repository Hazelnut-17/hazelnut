...
```json
{
  ...
  "tasks": {
    ...
    "verify": "deno run --allow-read --allow-write=. --allow-env --allow-run=deno -c deno.json file:///path/to/hazelnut/src/cli/hazelnut-core.ts verify ./app.ts",
    "add": "deno run --allow-read --allow-write=. --allow-env --allow-run=deno -c deno.json file:///path/to/hazelnut/src/cli/hazelnut-core.ts add",
