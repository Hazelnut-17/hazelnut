...
**This repository is the published form of the framework** — a Deno workspace of the packages below.
It is assembled one-way from a private development tree. The files you see will be overwritten by the
next release. That is not a contribution policy; it is what this repository is.
...
Pull requests that edit assembled source cannot land. See [`core/CONTRIBUTING.md`](./core/CONTRIBUTING.md).
